...
author: "Peirong Hao, Kevin Ying, Adam Bress, Tom Greene, Yizhe Xu^[Corresponding author: yizhe.xu@hsc.utah.edu]"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
bibliography: reference_ITT.bib  
link-citations: yes
objective: Estimate intention-to-treat effects on time-to-event outcomes using emulated trial data 
vignette: >
