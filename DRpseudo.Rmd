...
generate_data_noninf <- function(n = 2000) {
  Z1 <- rtruncnorm(n, a = -2, b = 2, mean = 0, sd = 1.0)
  Z2 <- rtruncnorm(n, a = -1.5, b = 1.5, mean = 0, sd = 0.5)
  Z3 <- rtruncnorm(n, a = -1, b = 1, mean = 0, sd = 0.25)
  Z4 <- rnorm(n, 0, 1.0)
  Z5 <- rnorm(n, 0, 0.5)
  
  logit_p <- -0.2 + 0.1 * Z1 + 0.9 * Z2 + 0.7 * Z3 + 0.5 * (Z1 * Z2)
