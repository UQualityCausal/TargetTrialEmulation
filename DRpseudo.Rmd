...
For doubly robust estimators for continuous and binary outcomes, please refer to the [AIPW] R package (https://cran.r-project.org/web/packages/AIPW/AIPW.pdf) from @zhong_aipw_2021.
