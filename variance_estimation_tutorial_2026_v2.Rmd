...
This document provides a complete implementation of variance estimation for inverse probability weighted (IPW) cumulative incidence functions (CIF) using influence functions.
