---
title: "Estimating the Variance of IP-Weighted Risk Ratios Using Influence Functions"
author: "Chong Zhang, Dan Scharfstein, Yizhe Xu^[Corresponding author: yizhe.xu@hsc.utah.edu]"
date: '`r Sys.Date()`'
output:
  pdf_document:
    toc: true
...
vignette: >
  \VignetteIndexEntry{Estimating the Variance of IP-Weighted Risk Ratios Using Influence Functions}
...
censor_time <- 40  # Administrative censoring
...
```{r plot-cif-naive, fig.width=10, fig.height=5}
...
```{r influence-components-description}
...
```{r compute-hazard-influence-improved}
...
```{r compute-cif-influence-improved}
...
```{r final-plot, fig.width=12, fig.height=5}
