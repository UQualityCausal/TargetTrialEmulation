...
link-citations: yes
objective: Estimate treatment effects on time-to-event outcomes using doubly robust methods 
vignette: >
...
?? Add R package for implementing the DR estimator for continuous and binary outcomes
...
colnames(results_package_tbl) <- c("T=1", "T=2", "T=3")
...
colnames(results_manual_tbl) <- c("T=1", "T=2", "T=3")
kable(results_manual_tbl, caption = "ATE (95% CIs)") %>% 
  kable_styling(full_width = FALSE, font_size = 12) 

# ??reformat the table to put point estimate and CIs in the same cell as how I have it in caption. Also add truth to this table 
```
